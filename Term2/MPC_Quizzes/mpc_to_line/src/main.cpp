...
int main() {
  ...
  /**
   * DONE: fit a polynomial to the above x and y coordinates
   */
  auto coeffs = polyfit(ptsx, ptsy, 1); // straight line so order 1
